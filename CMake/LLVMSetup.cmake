...
elseif(MSVC) # Didn't find LLVM via find_package. If we're on Windows, try installing via NuGet
    ...
    if(NUGET)
        ...
        execute_process(COMMAND ${NUGET} sources add -Name ${PACKAGE_SOURCE_NAME} -Source ${PACKAGE_SOURCE_URL} -UserName USER -Password ${PACKAGE_SOURCE_TOKEN} -ConfigFile ${NUGET_CONFIG_FILE} -StorePasswordInClearText -Verbosity detailed)
