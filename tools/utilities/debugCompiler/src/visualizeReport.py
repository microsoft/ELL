...
class LayerComparison:
    ...
    def parse_command_line(self, args):
        ...
        self.layers = self.load(args[1])
        return True

    def print_usage(self):
        print("Usage: visualize.py reportFileName")
        print("This tool shows layer by layer image comparisons using the report generated by the compare tool.")
...
if __name__ == '__main__':
    lc = LayerComparison()
    if (not lc.parse_command_line(sys.argv)):
        lc.print_usage()  
    else:
        lc.showLayers()
