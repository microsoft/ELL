...
if __name__ == "__main__":
    arg_parser = argparse.ArgumentParser(description="Featurized a single .wav file " +
        "the given featurizer.")
    ...
    arg_parser.add_argument("--dump", "-d", help="Dump the data to text files *.wav.txt and *.wav.features.txt", action="store_true")
