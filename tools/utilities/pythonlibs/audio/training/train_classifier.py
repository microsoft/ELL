...
class AudioDataset(Dataset):
    ...
    def __init__(self, filename, keywords):
        ...
        print("Loaded dataset {} and found sample rate {}, audio_size {}, input_size {}, window_size {} and shift {}".format(
            os.path.basename(filename), self.sample_rate, self.audio_size, self.input_size, self.window_size, self.shift
        ))
...
def train(epochs=30, hidden_units=128, learning_rate=1e-3, weight_decay=1e-5, batch_size=128, filename=None, evaluate_only=False, categories_file=None, wav_directory=None, architecture="GRU"):
    ...
    if model is None:
        print("Loading trained model with input size {}, hidden units {} and num keywords {}".format(test_data.input_size, hidden_units, test_data.num_keywords))  
...
if __name__ == '__main__':    
    ...
    train(args.epochs, args.hidden_units, args.learning_rate, args.weight_decay, args.batch_size, args.model, args.eval, args.categories, args.audio, args.architecture)
