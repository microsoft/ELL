...
//  File:     PrintableBinaryOpLayer.h (print)
...
struct PrintableBinaryOpLayer : public layers::BinaryOpLayer, public PrintableLayer
{
public:
    ...
    /// <summary> Assignment operator from BinaryOpLayer. </summary>
    ///
    /// <param name="layer"> The BinaryOpLayer layer to assign from.</param>
    void operator=(const layers::BinaryOpLayer& layer);
