...
//  File:     PrintableUnaryOpLayer.h (print)
...
struct PrintableUnaryOpLayer : public layers::UnaryOpLayer, public PrintableLayer
{
public:
    ...
    /// <summary> Assignment operator from UnaryOpLayer. </summary>
    ///
    /// <param name="layer"> The UnaryOpLayer layer to assign from.</param>
    void operator=(const layers::UnaryOpLayer& layer);
