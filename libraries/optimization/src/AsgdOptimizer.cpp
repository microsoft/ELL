...
optimization::AsgdOptimizer::AsgdOptimizer(uint64 dim) : _total_iterations(1), _lastPredictor(dim), _averagedPredictor(dim) // start with 1 to prevent divide-by-zero
{}
