...
namespace model
{
    ...
    ValueSelectorNode<ValueType>::ValueSelectorNode(const TypedInputGroup<bool>& condition, const TypedInputGroup<ValueType>& value1, const TypedInputGroup<ValueType>& value2) : Node({ &_condition, &_value1, &_value2 }, { &_output }), _condition(this, 0, condition), _value1(this, 1, value1), _value2(this, 2, value2), _output(this, 0, value1.Size())
    {
        if (condition.Size() != 1)
        {
