...
namespace model
{
    ...
    InputPortBase::InputPortBase(const class Node* owningNode, const OutputPortElements<ValueType>& input, std::string name) : Port(owningNode, name, Port::GetPortType<ValueType>(), input.Size()), _inputRanges(input)
    {
    ...
    //
    template <typename ValueType>
    InputPort<ValueType>::InputPort(const class Node* owningNode, const OutputPortElements<ValueType>& input, std::string name) : InputPortBase(owningNode, input, name), _input(input)
    {
    }
