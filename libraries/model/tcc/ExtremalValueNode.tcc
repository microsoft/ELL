...
namespace model
{
    ...
    ExtremalValueNode<ValueType, max>::ExtremalValueNode(const TypedOutputRef<ValueType>& input) : Node({ &_input }, { &_val, &_argVal }), _input(this, 0, input), _val(this, 0, 1), _argVal(this, 1, 1)
    {
    }
