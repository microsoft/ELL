...
namespace model
{
    ...
    ExtremalValueNode<ValueType, max>::ExtremalValueNode(const OutputPortRef<ValueType>& input) : Node({ &_input }, { &_val, &_argVal }), _input(this, input), _val(this, 1), _argVal(this, 1)
    {
    }
