...
namespace utilities
{
    ...
    public:
        ...
        /// <summary> Return the shape as a vector of integers </summary>
        ///
        /// <returns> The size per dimension of the shape </returns>
        const std::vector<int>& ToVector() const { return _shape; }
    ...
    public:
        ...
        MemoryLayout(const MemoryShape& size, const MemoryShape& padding);
        ...
        /// <param name="offset"> The offset into memory to the active area of the memory region. </param>
        MemoryLayout(const MemoryShape& size, const MemoryShape& stride, const MemoryShape& offset);
