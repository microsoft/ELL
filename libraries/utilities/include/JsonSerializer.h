...
namespace utilities
{
    ...
    protected:
        ...
        // virtual void BeginDeserializeArray(const char* name, ISerializable& value, SerializationContext& context) override;
        // virtual void DeserializeArrayItem(const char* name, ISerializable& value, SerializationContext& context) override;
        // virtual void EndDeserializeArray(const char* name, ISerializable& value, SerializationContext& context) override;
