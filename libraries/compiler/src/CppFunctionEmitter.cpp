...
//  File:     CppFunctionEmitter.cpp(compiler)
//  Authors:  Umesh Madan
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace emll
{
	namespace compiler
	{
		...
		CppFunctionEmitter& CppFunctionEmitter::IncrementUpdate(const std::string& varName)
		{
			_pCurBlock->IncrementUpdate(varName).Space();
			return *this;
		}
