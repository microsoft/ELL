...
namespace dsp
{
    /// <summary> Compute the discrete cosine transform (DCT) coefficient matrix for a given size DCT. </summary>
    ///
    /// <param name="size"> The size of the signal to be processed. </param>
    ///
    ...
    /// <summary> Compute the discrete cosine transform (DCT) of a vector of values, with an existing coefficient matrix. </summary>
    ///
    /// <param name="dctMatrix"> The DCT coefficient matrix. </param>
    /// <param name="signal"> The vector to compute the DCT of. </param>
    /// <param name="normalize"> A flag indicating if the DCT should be normalized. </param>
    ///
    ...
    /// <summary> Compute the discrete cosine transform (DCT) of a vector of values. </summary>
    ///
    /// <param name="signal"> The vector to compute the DCT of. </param>
    /// <param name="normalize"> A flag indicating if the DCT should be normalized. </param>
    ///
