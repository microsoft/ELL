...
#ifndef NDEBUG
#define DEBUG_CHECK( goodCondition, message ) if(!(goodCondition)) throw OptimizationException(message)
#else 
...
namespace optimization
{
    ...
    public:
        /// <summary></summary>
        OptimizationException(const std::string& message) : _message(message) {}
