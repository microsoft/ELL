...
namespace neural
{
    /// <summary> A layer in a neural network that implements a scaled input layer, meaning input of the nodes is multiplied by a scale factor to produce the output. </summary>
    class ScaledInputLayer : public ILayer
    {
    public:

        /// <summary> Instantiates an instance of a scaled input layer. </summary>
        ///
        ...
        /// <param name="numInputs"> The scale factor applied as a multiplication to the input to produce the scaled output. </param>
        ScaledInputLayer(size_t numNodes, double scaleFactor);
