...
namespace nodes
{
    ...
    template <typename ValueType>
    const model::OutputPort<ValueType>& DiagonalConvolution(const model::OutputPort<ValueType>& input,
                                                            const model::PortMemoryLayout& inputMemoryLayout,
                                                            const model::PortMemoryLayout& outputMemoryLayout,
                                                            const typename DiagonalConvolutionNode<ValueType>::ConstTensorReferenceType& filterWeights,
                                                            size_t stride);
...
namespace nodes
{
                                                            ...
                                                            size_t stride)
    {
        ...
        auto node = model->AddNode<DiagonalConvolutionNode<ValueType>>(input, inputMemoryLayout, outputMemoryLayout, filterWeights, stride);
        return node->output;
    }
} // namespace nodes
} // namespace ell
