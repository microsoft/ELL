...
namespace nodes
{
    ...
    template <typename ValueType>
    void SumNode<ValueType>::AddProperties(utilities::Archiver& description) const
    {
    ...
    template <typename ValueType>
    void SumNode<ValueType>::SetObjectState(const utilities::Archiver& description, utilities::SerializationContext& context)
    {
