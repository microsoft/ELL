...
namespace nodes
{
    ...
    UnaryOperationNode<ValueType>::UnaryOperationNode(const model::OutputPortElementList<ValueType>& input, OperationType operation) : Node({ &_input }, { &_output }), _input(this, input, inputPortName), _output(this, outputPortName, _input.Size()), _operation(operation)
    {
    }
