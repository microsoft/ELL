...
namespace nodes
{
    ...
    template <typename ValueType>
    void AccumulatorNode<ValueType>::AddProperties(utilities::Archiver& description) const
    {
    ...
    template <typename ValueType>
    void AccumulatorNode<ValueType>::SetObjectState(const utilities::Archiver& description, utilities::SerializationContext& context)
    {
