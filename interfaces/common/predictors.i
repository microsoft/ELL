...
%extend predictors::LinearPredictor
{
    ...
    {
        auto weightsLayerCoordinates = model.GetModel().AddLayer(std::make_unique<layers::Coordinatewise>($self->GetVector(), inputCoordinates, layers::Coordinatewise::OperationType::multiply));
