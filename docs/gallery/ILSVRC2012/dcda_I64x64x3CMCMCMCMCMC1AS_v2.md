...
## ILSVRC2012 Classification: 64x64x3 Convolutional Neural Network (46.23% top 1 accuracy, 70.90% top 5 accuracy, 0.79s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.79s/frame </td>
    </tr>
    <tr>
        <td> Uncompressed Size </td>
        <td colspan="3"> 69MB </td>
    </tr>
    <tr>
        <td> Input </td>
