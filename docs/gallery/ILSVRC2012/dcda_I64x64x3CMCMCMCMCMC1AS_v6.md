...
## ILSVRC2012 Classification: 64x64x3 Convolutional Neural Network (49.14% top 1 accuracy, 73.18% top 5 accuracy, 1.27s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 1.27s/frame </td>
    </tr>
    <tr>
        <td> Uncompressed Size </td>
        <td colspan="3"> 131MB </td>
    </tr>
    <tr>
        <td> Input </td>
