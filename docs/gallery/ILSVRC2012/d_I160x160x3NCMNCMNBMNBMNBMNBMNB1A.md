...
## ILSVRC2012 Classification: 160x160x3 Convolutional Neural Network (61.92% top 1 error, 36.84% top 5 error, 0.78s/frame on Raspberry Pi 3)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 0.78s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 800MHz: <br>DragonBoard 410c @ 1.2GHz:
|-
