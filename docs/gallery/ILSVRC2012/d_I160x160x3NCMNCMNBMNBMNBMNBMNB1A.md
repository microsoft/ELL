...
## ILSVRC2012 Classification: 160x160x3 Convolutional Neural Network (38.08% top 1 accuracy, 63.16% top 5 accuracy, 0.77s/frame on Raspberry Pi 3)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 0.77s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 800MHz: @pi3_64_SECONDS_PER_FRAME<br>DragonBoard 410c @ 1.2GHz: 0.32s/frame
|-
