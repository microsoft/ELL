...
## ILSVRC2012 Classification: 224x224x3 Convolutional Neural Network (60.21% top 1 accuracy, 82.48% top 5 accuracy, 0.49s/frame on Raspberry Pi 3)

<table>
    <tr>
        <td> Download </td>
        <td colspan="3"> <a href="https://github.com/Microsoft/ELL-models/raw/master/models/ILSVRC2012/d_I224x224x3CMCMCMCMCMCMC1A/d_I224x224x3CMCMCMCMCMCMC1A.ell.zip">d_I224x224x3CMCMCMCMCMCMC1A.ell.zip</a></td>
    </tr>
    <tr>
        <td> Accuracy </td>
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.49s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 600MHz: 0.52s/frame<br>DragonBoard 410c @ 1.2GHz: 0.28s/frame </td>
    </tr>
    <tr>
