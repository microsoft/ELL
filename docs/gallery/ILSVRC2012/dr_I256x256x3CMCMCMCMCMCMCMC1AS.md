...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (60.11% top 1 accuracy, 82.27% top 5 accuracy, 0.91s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.91s/frame </td>
    </tr>
    <tr>
