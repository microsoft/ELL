...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (59.46% top 1 accuracy, 81.94% top 5 accuracy, 0.49s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Accuracy </td>
        <td colspan="3"> ILSVRC2012: 81.94% (Top 5), 59.46% (Top 1) </td>
    </tr>
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.49s/frame </td>
    </tr>
    <tr>
