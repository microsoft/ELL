...
## ILSVRC2012 Classification: 192x192x3 Convolutional Neural Network (40.99% top 1 error, 18.26% top 5 error, 0.91s/frame)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 0.91s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 800MHz: <br>DragonBoard 410c @ 1.2GHz:
|-
