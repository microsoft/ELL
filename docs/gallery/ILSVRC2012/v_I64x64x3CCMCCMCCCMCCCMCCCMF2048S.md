...
## ILSVRC2012 Classification: 64x64x3 Convolutional Neural Network (57.12% top 1 accuracy, 80.49% top 5 accuracy, 0.78s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.78s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 600MHz: 0.81s/frame<br>DragonBoard 410c @ 1.2GHz: 0.45s/frame </td>
    </tr>
    <tr>
