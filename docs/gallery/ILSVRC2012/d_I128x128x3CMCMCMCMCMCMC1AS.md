...
## ILSVRC2012 Classification: 128x128x3 Convolutional Neural Network (52.06% top 1 accuracy, 76.43% top 5 accuracy, 300ms/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 300ms/frame </td>
    </tr>
    <tr>
    ...
    <tr>
        <td> Architecture </td>
        <td>
            <a href="https://github.com/Microsoft/ELL-models/raw/master/models/ILSVRC2012/d_I128x128x3CMCMCMCMCMCMC1AS/d_I128x128x3CMCMCMCMCMCMC1AS.cntk.svg?sanitize=true" target="_blank">d_I128x128x3CMCMCMCMCMCMC1AS architecture (SVG)</a>
        </td>
    </tr>
    <tr>
        <td> Output </td>
