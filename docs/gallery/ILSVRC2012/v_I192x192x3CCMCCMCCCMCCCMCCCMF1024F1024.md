...
## ILSVRC2012 Classification: 192x192x3 Convolutional Neural Network (63.50% top 1 accuracy, 85.33% top 5 accuracy, 7.24s/frame on Raspberry Pi 3)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 7.24s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 600MHz: 6.67s/frame<br>DragonBoard 410c @ 1.2GHz: 8.33s/frame
|-
