...
## ILSVRC2012 Classification: 224x224x3 Convolutional Neural Network (64.30% top 1 error, 39.74% top 5 error, 1.67s/frame)
...
|-
| Accuracy | ILSVRC2012: 60.26% (Top 5), 35.70% (Top 1) 
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 1.67s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 800MHz: <br>DragonBoard 410c @ 1.2GHz:
|-
