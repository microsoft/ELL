...
## ILSVRC2012 Classification: 224x224x3 Convolutional Neural Network (36.52% top 1 accuracy, 60.89% top 5 accuracy, 1.41s/frame on Raspberry Pi 3)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 1.41s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 600MHz: 0.97s/frame<br>DragonBoard 410c @ 1.2GHz: 0.58s/frame
|-
