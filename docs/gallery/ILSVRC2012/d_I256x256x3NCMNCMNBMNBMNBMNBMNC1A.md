...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (40.42% top 1 accuracy, 65.38% top 5 accuracy, 1.43s/frame on Raspberry Pi 3)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 1.43s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 600MHz: 1.39s/frame<br>DragonBoard 410c @ 1.2GHz: 0.70s/frame
|-
