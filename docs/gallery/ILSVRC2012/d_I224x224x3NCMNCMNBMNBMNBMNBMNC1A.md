...
## ILSVRC2012 Classification: 224x224x3 Convolutional Neural Network (61.63% top 1 error, 36.54% top 5 error, 1.55s/frame on Raspberry Pi 3)
...
|-
| Performance | Raspberry Pi 3 (Raspbian) @ 700MHz: 1.55s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 800MHz: <br>DragonBoard 410c @ 1.2GHz:
|-
