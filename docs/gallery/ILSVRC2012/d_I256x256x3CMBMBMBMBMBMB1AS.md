...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (37.91% top 1 accuracy, 62.42% top 5 accuracy, 1.05s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 1.05s/frame<br>Raspberry Pi 3 (OpenSUSE) @ 600MHz: 0.82s/frame<br>DragonBoard 410c @ 1.2GHz: 0.50s/frame </td>
    </tr>
    <tr>
