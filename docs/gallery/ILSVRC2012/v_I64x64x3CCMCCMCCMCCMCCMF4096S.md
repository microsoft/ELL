...
## ILSVRC2012 Classification: 64x64x3 Convolutional Neural Network (60.72% top 1 accuracy, 83.02% top 5 accuracy, 0.65s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.65s/frame </td>
    </tr>
    <tr>
