...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (62.65% top 1 accuracy, 84.27% top 5 accuracy, 0.86s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.86s/frame </td>
    </tr>
    <tr>
        <td> Uncompressed Size </td>
        <td colspan="3"> 150MB </td>
    </tr>
    <tr>
        <td> Input </td>
