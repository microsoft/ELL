...
## ILSVRC2012 Classification: 128x128x3 Convolutional Neural Network (61.29% top 1 accuracy, 83.57% top 5 accuracy, 690ms/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 690ms/frame </td>
    </tr>
    <tr>
