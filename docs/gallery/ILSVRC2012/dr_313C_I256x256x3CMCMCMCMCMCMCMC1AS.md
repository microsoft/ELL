...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (65.18% top 1 accuracy, 86.31% top 5 accuracy, 0.95s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.95s/frame </td>
    </tr>
    <tr>
        <td> Uncompressed Size </td>
        <td colspan="3"> 237MB </td>
    </tr>
    <tr>
        <td> Input </td>
