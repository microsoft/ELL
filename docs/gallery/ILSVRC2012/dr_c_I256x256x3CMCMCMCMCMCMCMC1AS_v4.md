...
## ILSVRC2012 Classification: 256x256x3 Convolutional Neural Network (37.07% top 1 accuracy, 61.50% top 5 accuracy, 0.13s/frame on Raspberry Pi 3)
...
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td> Performance </td>
        <td colspan="3"> Raspberry Pi 3 (Raspbian) @ 700MHz: 0.13s/frame </td>
    </tr>
    <tr>
