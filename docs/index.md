...
laptop or desktop computer. If you intend to deploy models onto a Raspberry Pi, follow our instruction on [setting up the Rasberry Pi](/ELL/tutorials/Setting-Up-your-Raspberry-Pi).
