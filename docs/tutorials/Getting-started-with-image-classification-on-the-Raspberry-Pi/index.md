...
```shell
[Linux/macOS] cp ../../../docs/tutorials/shared/tutorial_helpers.py pi3
...
Import the helper code that we copied over.
...
We are ready to move to the Raspberry Pi. If your Pi is accessible over the network, you can copy the `pi3` directory using the Unix `scp` tool or the Windows [WinSCP](https://winscp.net/eng/index.php) tool.
